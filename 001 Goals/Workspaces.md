...
completionDate: 
completed: false
created_at: 2025-02-21T11:02:39-05:00
---
...
- local cache of 'true' workspace layouts that can be injected over .obsidian/workspaces.json to revert to vanilla at the start of each day
	- hotkey to reload current workspace
	- 
## Related:
