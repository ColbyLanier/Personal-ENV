---
title: "Zabakes/togle-script: This is a program that lets you make custom keyboard layers for each progrma you use. It then displays the function of each key when a toggle key is held."
source: "https://github.com/Zabakes/togle-script"
author:
  - "[[GitHub]]"
published:
created: 2025-03-04
description: "This is a program that lets you make custom keyboard layers for each progrma you use. It then displays the function of each key when a toggle key is held. - Zabakes/togle-script"
tags:
  - "clippings"
---
## toggle-script
...
[![GUI example](https://github.com/Zabakes/togle-script/raw/master/Images/GUI_example.png)](https://github.com/Zabakes/togle-script/blob/master/Images/GUI_example.png)

You can change where the keys go with the [layout](https://github.com/Zabakes/#layout--path) for a keyboard like the ergodex this would look like  
[![GUI example](https://github.com/Zabakes/togle-script/raw/master/Images/AltLayout.png)](https://github.com/Zabakes/togle-script/blob/master/Images/AltLayout.png)
...
[![GUI example edit](https://github.com/Zabakes/togle-script/raw/master/Images/GUI_edit.png)](https://github.com/Zabakes/togle-script/blob/master/Images/GUI_edit.png)
...
This is a list of all the keys to be re-mapped. The order of the list should match the order of the [hks](https://github.com/Zabakes/#hks--listaction--listlistaction) Each key has the following attributes.
...
This is an [action](https://github.com/Zabakes/#actions--obj) to take when the key is pressed without the toggle key.
...
This is the path the keyboard layout json. This does not support rotation. The layout can be generated/downloaded from [here](http://www.keyboard-layout-editor.com/#/) (This is not my work but it's cool so I used the same format). The legends in this layout should match the [remap](https://github.com/Zabakes/#remap--str) name.
...
These are the prefixes for use in [actions](https://github.com/Zabakes/#actions--obj) using these prefixes actions can invoke pyhton functions defined in the customFuncs module. each object should contain :
...
This is the name of the python function to be called. The argument to this function is whatever follows the prefix in the [command](https://github.com/Zabakes/#command--str)
...
This is the name of the application that this config applies to. This takes priority over the [regex](https://github.com/Zabakes/#regex--str).
...
### hks : list\[[action](https://github.com/Zabakes/#actions--obj)\] | list\[list\[[action](https://github.com/Zabakes/#actions--obj)\]\]

This is a list of actions to map to the keys to the keys specified in [Keys](https://github.com/Zabakes/#keys--listkey), this is done based on index. If a list of actions is used instead of an action those actions will be added to layers. The default layer is the first entry.

You can create an action to set/change the current layer by invoking the [setLayer](https://github.com/Zabakes/#setLayer) [function](https://github.com/Zabakes/#Function--obj).
...
### Press : [Function](https://github.com/Zabakes/#Function--obj) | [command](https://github.com/Zabakes/#command--str)

This is what happens when the key is pressed. It can be either a function or a command.

default : Nothing

### Rel : [Function](https://github.com/Zabakes/#Function--obj) | [command](https://github.com/Zabakes/#command--str)
...
Strings are just sent as written but commands are wrapped in curly braces `{}` A command to send when it is parsed using the regex :
...
- If the cmd group matches check for a prefix from [Funcs](https://github.com/Zabakes/#funcs--listobj) if it is present strip it and pass the rest of the command to the function as a string.
