...
RunTP(cmdName, args := []) {
    ...
    try {
        Run('obsidian://advanced-uri?vault=Personal-ENV&eval=' tpFunc '(' argBuf ');',, "Hide")
    } catch as err {
...
; Run('obsidian://advanced-uri?vault=Personal-ENV&eval=app.plugins.plugins%5B%27templater-obsidian%27%5D.templater.current_functions_object.user.setmatter%28%7B%22Workspace%22%3A%20%221-Obsidian%22%7D%29',, "Hide")
