...
# Inductive Step
New approach: do not jump in to the inductive step with an inequality. scout the IS with only the def of the func at k+1. After this scouting we make substitutions with the IH, rather than trying to viper press